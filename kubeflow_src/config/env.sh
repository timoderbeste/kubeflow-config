PLATFORM=null
KUBEFLOW_REPO=/Users/timowang/Entwickler/kubeflow-config/kubeflow_src
...
KUBEFLOW_KS_DIR=/Users/timowang/Entwickler/kubeflow-config/kubeflow_src/config/ks_app
